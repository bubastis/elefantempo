...
base('Elefantempo').select({
    ...
    records.forEach(function(record) {
        ...
        maxtempdate.innerText = recordDate.getDate() + "/" + (recordDate.getMonth() + 1) + "/" + recordDate.getFullYear() + ' at ' + recordDate.getHours() + ':' + recordDate.getMinutes();
    });
...
base('Elefantempo').select({
    ...
    records.forEach(function(record) {
        ...
        let recordDate = new Date(record._rawJson.createdTime)
        mintempdate.innerText = recordDate.getDate() + "/" + (recordDate.getMonth() + 1) + "/" + recordDate.getFullYear() + ' at ' + recordDate.getHours() + ':' + recordDate.getMinutes();
    });
