...
// 
// Host it at Google Apps Script
// https://script.google.com/home

// Enter Spreadsheet ID here, between ''
...
function doPost(e) {
  ...
  if (parsedData !== undefined){
    ...
    var date_now = Utilities.formatDate(new Date(), "GMT", "yyyy-MM-dd HH:mm"); // gets the current date
    ...
    switch (parsedData.command) {
      ...
      case "insert_row":
         ...
         sheet.getRange('B2').setValue(value0);   // publish value0 from Arduino code to cell B2
         sheet.getRange('C2').setValue(value1);   // publish value1 from Arduino code to cell C2
         sheet.getRange('D2').setValue(value2);   // publish value2 from Arduino code to cell D2
